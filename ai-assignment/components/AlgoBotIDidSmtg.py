...
#from group1godineedsleep import group1
...
class Bot:
    def __init__(self, game, color, method='random', depth=3):
    ...
    def move(self, current_pos, final_pos, board):
        ...
        if self.game.continue_playing == False:
            if board.getSquare(final_pos[0], final_pos[1]).squarePiece is not None and board.getSquare(final_pos[0],final_pos[1]).squarePiece.color == self.game.turn:
